...
// [SIGMA]++++++++++++++++++++++++++++++++++++++++++++++++++ {{{{{
    // printf("====mpctx->video_out->params->w/h [%dx%d] \n",mpctx->video_out->params->w ,mpctx->video_out->params->h);
// [SIGMA]++++++++++++++++++++++++++++++++++++++++++++++++++ }}}}}
...
// [SIGMA]++++++++++++++++++++++++++++++++++++++++++++++++++ {{{{{
        /*  if image-params of new-video is not equal with old-video,
            then change the vo params */
        // printf("=====> Vo_Dmx_ReInit Start.\n");
        if( false == Vo_Dmx_Is_Inited( ) )
        {
            Vo_Dmx_Init( &p, mpctx );
        }
        else
        {
            // Vo_Dmx_Deinit( );
            // Vo_Dmx_Init( &p, mpctx );
            Vo_Dmx_ChangeParam( &p );
        }
        // printf("<===== Vo_Dmx_ReInit Done.\n");
// [SIGMA]++++++++++++++++++++++++++++++++++++++++++++++++++ }}}}}
    }
