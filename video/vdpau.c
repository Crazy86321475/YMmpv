                                               ...
                                               struct mp_image *mpi)
{
    ...
    // [SIGMA] SW-DEC. put YUV to VDPAU
    if (hwmpi->imgfmt == IMGFMT_VDPAU) {
        // [SIGMA] IMGFMT_VDPAU. put YUV to VDPAU video_surface
        ...
        // [SIGMA] IMGFMT_VDPAU_OUTPUT. put RGB to VDPAU output_surface
