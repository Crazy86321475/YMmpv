...
// [SIGMA]++++++++++++++++++++++++++++++++++++++++++++++++++ {{{{{
static mp_image_t* _img_frame_current = NULL;
// [SIGMA]++++++++++++++++++++++++++++++++++++++++++++++++++ }}}}}
...
// [SIGMA]++++++++++++++++++++++++++++++++++++++++++++++++++ {{{{{
    /* do vo-dmx */
    int ret;
    ret = Vo_Dmx_Process( vdp, _img_frame_current );
    _img_frame_current = NULL;
    if( ret )
        goto drop;
...
// [SIGMA]++++++++++++++++++++++++++++++++++++++++++++++++++ {{{{{
    ...
    // if( _img_frame_current )
    // {
    //     talloc_free( _img_frame_current );
    // }
    // _img_frame_current = mp_image_new_copy( frame->current );
// [SIGMA]++++++++++++++++++++++++++++++++++++++++++++++++++ }}}}}
